...
import { valorPorExtenso, formatarMoeda, parseMoeda, formatarDataExtenso, formatarDataISO, maskData } from '@/lib/utils';
      ...
      <div className="card p-6 mb-6">
        ...
        <div className="flex gap-4 items-end flex-wrap">
          ...
          <div>
            ...
            />
            {dataExtenso && (
              <p className="text-xs text-gray-500 mt-1">{dataExtenso}</p>
            )}
          </div>
        </div>
      </div>
    ...
    <div className="border border-cream-300 rounded-xl p-4 bg-cream-50">
      <div className="flex items-start gap-3 flex-wrap">
        ...
        <div className="w-36">
          ...
          />
          {extenso && (
            <p className="text-xs text-gray-500 mt-1 leading-tight">{extenso}</p>
          )}
        </div>
