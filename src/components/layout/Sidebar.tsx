...
const NAV = [
  { href: '/dashboard',              label: 'Painel',          icon: '⊞', adminOnly: false },
  { href: '/dashboard/gratificacoes',label: 'Gratificações',   icon: '📄', adminOnly: false },
  { href: '/dashboard/funcionarios', label: 'Funcionários',    icon: '👥', adminOnly: false },
  { href: '/dashboard/historico',    label: 'Histórico',       icon: '🕓', adminOnly: false },
  { href: '/dashboard/admin',        label: 'Usuários',        icon: '⚙️',  adminOnly: true  },
];
    ...
    <aside className="fixed left-0 top-0 h-full w-[240px] bg-forest-950 flex flex-col z-40">
      ...
      <div className="px-6 py-6 border-b border-forest-800">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-white font-semibold text-sm leading-tight">ERP Admin</p>
            <p className="text-forest-400 text-xs">Gratificações</p>
          </div>
        </div>
      </div>
